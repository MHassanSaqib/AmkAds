      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        >
          <div className="absolute top-0 right-0 hidden md:block">
            <Image src="/images/new-amk-ads-logo.png" alt="AMK ADS" width={150} height={64} loading="lazy" decoding="async" className="h-16 w-auto object-contain bg-white rounded-xl p-2 shadow-lg" />
          </div>
