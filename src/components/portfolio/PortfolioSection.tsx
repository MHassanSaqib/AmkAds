      ...
      <div ref={ref} className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        >
          {filtered.map((brand, i) => (
            ...
            >
              <div className="w-full min-h-[100px] flex items-center justify-center overflow-hidden group-hover:scale-110 transition-transform duration-300 mb-2 bg-white rounded-md p-4 shadow-sm">
                <Image 
                  src={brand.logo} 
                  alt={brand.name}
                  width={150}
